...
import { ChevronRight, Sparkles, ArrowRight, Leaf } from "lucide-react";
    ...
    <section ref={containerRef} className="relative min-h-[450px] md:min-h-[550px] flex items-center overflow-hidden">
      ...
      <div className="absolute top-1/4 right-1/4 opacity-30">
        <FloatingElement delay={1}>
          <Sparkles className="w-10 h-10 text-accent-warm/50" />
        </FloatingElement>
      </div>

      <div className="absolute bottom-1/4 left-1/4 opacity-30">
        <FloatingElement delay={3}>
          <Leaf className="w-8 h-8 text-accent/50" />
        </FloatingElement>
      </div>
            ...
            <div className="relative p-8 rounded-3xl bg-white/60 backdrop-blur-sm border border-white/50 shadow-2xl">
              <div className="grid grid-cols-2 gap-6">
                <div className="text-center">
                  ...
                  <p className="text-sm text-text-secondary">Treatments</p>
                </div>
                ...
                <div className="text-center">
                  ...
                  >
                    <Leaf className="w-8 h-8 text-accent-warm" />
                  </m.div>
                  <p className="text-3xl font-bold text-primary">100%</p>
                  <p className="text-sm text-text-secondary">Natural</p>
                </div>
              </div>
